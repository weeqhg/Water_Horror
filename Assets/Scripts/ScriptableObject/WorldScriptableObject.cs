...
public class WorldScriptableObject : ScriptableObject
{
    ...
    [Header("Настройки UI")] public Sprite Icon;
    public LocalizedString nameLocation;
    public string depth;
    public int difficulty;
    
    [Header("Настройки размера карты")] public int width = 512;
    ...
    [Header("Advanced Noise")] public int octaves = 4;
    public float persistence = 0.5f;
    public float lacunarity = 2f;

    [Header("Terrain Material")] public Material terrainMaterial;

    [Header("Объекты на локации")] public List<SpawnObject> spawnObjects = new();

    [Header("Враги на локации")] public List<InteractiveObject> spawnEnemies = new();
